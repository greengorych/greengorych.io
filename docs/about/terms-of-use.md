...
The materials on this website are provided "as is", without any warranties, express or implied. The author assumes no responsibility for possible errors, omissions, or any consequences resulting from the use of the published texts, code samples, or configuration files.
